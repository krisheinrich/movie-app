describe('omdb service', function() {
  ...
  it('should return movie data by id', function() {
    var res,
        expectedUrl = 'http://www.omdbapi.com/?v=1&i=tt0076759';
    ...
    expect(res).toEqual(movieDataById);
  });
